...
temperature_icon=$(tmux_get '@tmux_power_temperature_icon' '')
...
show_temperature="$(tmux_get @tmux_power_show_temperature false)"
...
if "$show_temperature"; then
    RS="#[fg=$TC,bg=$BG]$temperature_icon #{temperature} $RS"
fi
